(function(l, e) {
  ...
  function e(a) {
    ...
    "undefined" === typeof window._progressjsIntervals &&
      (window._progressjsIntervals = {});
    this._options = { theme: "blue", overlayMode: !1, considerTransition: !0 };
  }
  function m(a, c) {
    var d = this;
    100 <= c && (c = 100);
    a.hasAttribute("data-progressjs") &&
      setTimeout(function() {
        "undefined" != typeof d._onProgressCallback &&
          d._onProgressCallback.call(d, a, c);
        var b = h(a);
  ...
  function p(a) {
    for (var c = 0, d = this._targetElement.length; c < d; c++) {
      ...
      if (b.hasAttribute("data-progressjs")) {
        var g = h(b);
        (g = parseInt(g.style.width.replace("%", ""))) &&
          m.call(this, b, g + (a || 1));
      }
    }
  }
  ...
  var n = function(a) {
    if ("object" === typeof a) return new e(a);
    if ("string" === typeof a) {
  ...
  n.fn = e.prototype = {
      ...
      for (var a = 0, c = this._targetElement.length; a < c; a++) {
        ...
        if (!d.hasAttribute("data-progressjs")) {
          ...
          "body" === b.tagName.toLowerCase()
            ? ((g = b.clientWidth), (e = b.clientHeight))
            : ((g = b.offsetWidth), (e = b.offsetHeight));
          for (
            var f = (j = 0);
            b && !isNaN(b.offsetLeft) && !isNaN(b.offsetTop);

          )
            (j += b.offsetLeft), (f += b.offsetTop), (b = b.offsetParent);
          b = f;
          ...
          f.style.position =
            "body" === d.tagName.toLowerCase() ? "fixed" : "absolute";
          ...
          h.innerHTML = "1%";
          k.appendChild(h);
          this._options.overlayMode && "body" === d.tagName.toLowerCase()
            ? ((f.style.left = 0),
              (f.style.right = 0),
              (f.style.top = 0),
              (f.style.bottom = 0))
            : ((f.style.left = j + "px"),
              (f.style.top = b + "px"),
              (f.style.width = g + "px"),
              this._options.overlayMode && (f.style.height = e + "px"));
          f.appendChild(k);
    ...
    set: function(a) {
      for (var c = 0, d = this._targetElement.length; c < d; c++)
        m.call(this, this._targetElement[c], a);
      return this;
    },
    increase: function(a) {
      p.call(this, a);
    ...
    autoIncrease: function(a, c) {
      var d = this,
        b = parseInt(this._targetElement[0].getAttribute("data-progressjs"));
      "undefined" != typeof window._progressjsIntervals[b] &&
        clearInterval(window._progressjsIntervals[b]);
      ...
      a: {
        "undefined" != typeof this._onBeforeEndCallback &&
          (!0 === this._options.considerTransition
            ? h(this._targetElement[0]).addEventListener(
                q(),
        ...
        for (
          ...
          if (!e) break a;
          var l = 1;
          100 > parseInt(e.style.width.replace("%", "")) &&
            (m.call(this, b, 100), (l = 500));
          (function(a, b) {
            setTimeout(function() {
        ...
        if (window._progressjsIntervals[a])
          try {
            clearInterval(window._progressjsIntervals[a]),
              (window._progressjsIntervals[a] = null),
              delete window._progressjsIntervals[a];
          } catch (j) {}
      }
      return this;
    },
    ...
    onbeforestart: function(a) {
      if ("function" === typeof a) this._onBeforeStartCallback = a;
        ...
        throw Error("Provided callback for onbeforestart was not a function");
      return this;
    },
